...
class desktopHeader extends Connected<typeof React.Component, IProps & WithStyles<typeof styles> & RouteComponentProps<{}>, IState, AppStore>(React.Component)
{
...
const DesktopHeaderComponent = withRoot(withStyles(styles)(desktopHeader));
